...
dailyReturns <- calculateDailyReturns(russell2000$Close)
weeklyReturns <- calculateWeeklyReturns(russell2000$Close)
monthlyReturns <- calculateMonthlyReturns(russell2000$Close)
yearlyReturns <- calculateYearlyReturns(russell2000$Close)
